...
# Edit CONFIG, then: ./run_cn_merge_celltypes_unified_n=6.sh
# Or: ./run_cn_merge_celltypes_unified_n=6.sh -- ... (pass-through to Python)

set -euo pipefail

# ========== CONFIG ==========
SOURCE_TILES_DIR="/mnt/j/HandE/results/SOW1885_n=201_AT2 40X/JN_TS_001-013/pred_03_26/h5ad"
MERGED_TILES_DIR="/mnt/j/HandE/results/SOW1885_n=201_AT2 40X/JN_TS_001-013/pred_03_26/h5ad_staged_n=6"
OUTPUT_DIR="/mnt/j/HandE/results/SOW1885_n=201_AT2 40X/JN_TS_001-013/pred_03_26/cn_unified_results_n=6"
K=20
N_CLUSTERS=6
